...
public class BorrowDAOTest {
    ...
    void testBorrowBookAndRetrieve() throws SQLException {
        ...
        assertEquals(BorrowStatus.BORROWED, borrows.get(0).getStatus());
        assertEquals(testBook.getTitle(), borrows.get(0).getBook().getTitle());
    }
    ...
    void testReturnBook() throws SQLException {
        ...
        assertEquals(today, returned.getReturnDate());
    }
